...
import (
	...
	"github.com/chaturanand/go-todo-rest-api-example/app/handler"
	"github.com/chaturanand/go-todo-rest-api-example/app/model"
...
func (a *App) Initialize(config *config.Config) {
	...
	db, err := gorm.Open("mysql", "root:root@tcp(127.0.0.1:3306)/go_task?charset=utf8&parseTime=True")
	if err != nil {
